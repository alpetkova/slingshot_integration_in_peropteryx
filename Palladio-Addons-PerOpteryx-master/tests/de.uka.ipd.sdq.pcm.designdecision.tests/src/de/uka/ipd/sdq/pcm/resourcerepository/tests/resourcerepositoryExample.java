...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>resourcerepository</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class resourcerepositoryExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(resourcerepositoryPackage.eNS_URI, resourcerepositoryPackage.eINSTANCE);
