 ...
 * @generated
 */
public class qualitypropertiesActionBarContributor extends EditingDomainActionBarContributor
	 ...
	 * @generated
	 */
	public qualitypropertiesActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("qualityproperties-settings"));
		toolBarManager.add(new Separator("qualityproperties-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				DesignDecisionEditorPlugin.INSTANCE.getString("_UI_qualitypropertiesEditor_menu"),
				"de.uka.ipd.sdq.pcm.designdecision.qualitypropertiesMenuID");
