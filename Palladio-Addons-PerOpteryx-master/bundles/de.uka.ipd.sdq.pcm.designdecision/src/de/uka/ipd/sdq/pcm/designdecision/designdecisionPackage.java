 ...
 * </ul>
 * <!-- end-user-doc --> <!-- begin-model-doc --> The DesignDecisions metamodel represents degrees
 * of freedom that can be exploited for optimisation.
 *
 * The core idea is each degree of freedom can be represented by a DegreeOfFreedom element. Each
 * DegreeOfFreedom has two parts: It links a model element that is the changeable entity in this
 * DegreeOfFreedom, and it specifies a Domain of possible values that the model element can take.
 *
 * The actual making of a decision is represented in the Choice element. For a specific candidate
 * architecture, one Choice for each DegreeOfFreedom in the Problem as to be made. The Choice
 * contains a reference to the DegreeOfFreedom that it decides and a reference to a value from the
 * DegreeOfFreedom's Domain that represent the selected value. See the diagram "Design and Choice"
 * for an overview of DegreeOfFreedom, Domain and Choice.
 *
 * All of the above mentioned elements are abstract and are subclassed for the different generic
 * degrees of freedom. For example, the degree of freedom of "component allocation" is represented
 * in the AllocationDegree. See the documentation of each subclass of design decision for details.
 * The diagram AssembledComponentDegree visualises the subclassing for the example degree of freedom
...
public interface designdecisionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int DEGREE_OF_FREEDOM_INSTANCE__DECORATOR_MODEL = EntityPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int DEGREE_OF_FREEDOM_INSTANCE_FEATURE_COUNT = EntityPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * {@link de.uka.ipd.sdq.pcm.designdecision.DegreeOfFreedomInstance#getDof <em>Dof</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the meta object for the reference list '{@link de.uka.ipd.sdq.pcm.designdecision.DegreeOfFreedomInstance#getDecoratorModel <em>Decorator Model</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Decorator Model</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.DegreeOfFreedomInstance#getDecoratorModel()
	 * @see #getDegreeOfFreedomInstance()
	 * @generated
	 */
	 ...
	 * {@link de.uka.ipd.sdq.pcm.designdecision.Choice#isActive <em>Is Active</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link de.uka.ipd.sdq.pcm.designdecision.Choice#getValue <em>Value</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * {@link de.uka.ipd.sdq.pcm.designdecision.Candidate#getChoices <em>Choices</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link de.uka.ipd.sdq.pcm.designdecision.Candidates#getCandidate <em>Candidate</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the meta object for the reference '
	 * {@link de.uka.ipd.sdq.pcm.designdecision.Candidates#getProblem <em>Problem</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	interface Literals {
		 ...
		 * {@link de.uka.ipd.sdq.pcm.designdecision.impl.DegreeOfFreedomInstanceImpl
		 * <em>Degree Of Freedom Instance</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
		 * -->
		 *
		 * @see de.uka.ipd.sdq.pcm.designdecision.impl.DegreeOfFreedomInstanceImpl
		 * @see de.uka.ipd.sdq.pcm.designdecision.impl.designdecisionPackageImpl#getDegreeOfFreedomInstance()
		 ...
		 * @generated
		 */
		EReference DEGREE_OF_FREEDOM_INSTANCE__DECORATOR_MODEL = eINSTANCE.getDegreeOfFreedomInstance_DecoratorModel();
