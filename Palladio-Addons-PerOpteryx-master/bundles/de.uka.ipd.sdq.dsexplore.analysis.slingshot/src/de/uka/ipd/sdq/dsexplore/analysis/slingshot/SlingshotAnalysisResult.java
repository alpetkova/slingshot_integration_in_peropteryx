...
abstract public class SlingshotAnalysisResult extends AbstractPerformanceAnalysisResult implements IStatisticAnalysisResult, IPerformanceAnalysisResult {
    ...
    protected SlingshotQualityAttributeDeclaration qualityAttributeInfo;
    ...
    protected SlingshotAnalysisResult(final PCMInstance pcm) {
        super(pcm);
    }
