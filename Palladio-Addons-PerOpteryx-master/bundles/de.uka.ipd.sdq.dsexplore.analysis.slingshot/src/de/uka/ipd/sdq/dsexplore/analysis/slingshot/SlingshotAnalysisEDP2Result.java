...
public class SlingshotAnalysisEDP2Result extends SlingshotAnalysisResult {
	 ...
	 */
	public SlingshotAnalysisEDP2Result(final ExperimentRun run, final ExperimentSetting experiment,
	...
	static public IStatisticAnalysisResult findExperimentRunAndCreateResult(final Entity pcmEntity,
			...
			final SlingshotQualityAttributeDeclaration qualityAttribute) throws AnalysisFailedException {
