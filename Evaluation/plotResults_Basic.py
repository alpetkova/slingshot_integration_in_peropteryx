...
# activeCSVInPath = Path("./csvs/Basic/0022/allCandidates2_2025-05-03-002201.csv")
# activeCSVInPath = Path("./csvs/Basic/0058/allCandidates2_2025-05-03-005856.csv")
activeCSVInPath = Path("./csvs/Basic/0118/allCandidates2_2025-05-03-011838.csv")
# activeCSVInPath = Path("./csvs/Basic/0135/allCandidates2_2025-05-03-013519.csv")

# specify figure output directory
figOutPath = Path("./plots/Basic/")

# pareto front indices
idxParetoFront = [16, 9, 18, 13] # manualy determined from 0118
...
fig.savefig(figOutPath / (f"{activeCSVInPath.parent.stem}_basic_perf_cost.eps"), dpi=fig.dpi)
plt.close(fig)
...
fig.savefig(figOutPath / (f"{activeCSVInPath.parent.stem}_basic_barChart.eps"), dpi=fig.dpi)
plt.close(fig)
